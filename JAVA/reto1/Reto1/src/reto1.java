...
public class reto1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int fila=0;fila<numero_de_estudiantes;fila++){
            ...
            System.out.println("Ingrese el nombre, genero, matería y calificación. Separados por espacio");
        ...
        for (int fila=0;fila<numero_de_estudiantes;fila++){
            ...
            if(desempeño_de_estudiantes [fila][3] > 4.5){
                notas_excelentes +=1;
            }
            
        }
        System.out.println("la cantidad de notas inferiores al promedio, son: "+notas_inferiores_a_promedio);
        System.out.println("la cantidad de notas excelentes, son: "+ notas_excelentes);
        float porcentaje = ((notas_excelentes*100)/numero_de_estudiantes);
        System.out.println("el porcentaje de notas excelentes, es: "+ porcentaje +"%");

        //¿Cuál es la materia con el mayor numero de examenes reprobados
        // Definimos los contadores para las materias: 1,2 y 3
        int materia_1 = 0; int materia_2 = 0; int materia_3 = 0;

        for (int fila=0;fila<numero_de_estudiantes;fila++){
            if (desempeño_de_estudiantes [fila][2]== 1) {
                if (desempeño_de_estudiantes [fila][3]<= 2.5) {           
                    materia_1 += 1;
                }
            }
        ...
        // Comparamos las cantidades de examenes reprobados de cada materia, para definir la materia con mayor número de examenes reprobados
        if (materia_1 > materia_2 && materia_1 > materia_3){
            System.out.println("la materia con mayor reprobación es: materia 1"); 
        } 
        else if (materia_2 > materia_3){
            System.out.println("la materia con mayor reprobación es: materia 2"); 
        } 
        else {
            System.out.println("la materia con mayor reprobación es: materia 3");
        }

        //¿Cuál es el estudiante con el mejor desempeño para la materia idiomas?
        float mayor_nota = 0f; Float estudiante_mejor=0f;
        for (int fila=0;fila<numero_de_estudiantes;fila++){
            if (desempeño_de_estudiantes [fila][2]==1) {
        ...
        System.out.println("El estudiante con mejor desempeño en la materia 1 es: " + nombreestudiante);
