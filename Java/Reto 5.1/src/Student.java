...
// Reto 5 Curso Programacion Basica MINTIC - Universidad del Norte
...
public class Student extends GradingSystem {
    ...
    public static void loadData() {
        ...
        for (int fila = 0; fila < numeroDeCalificaciones; fila++) {
            ...
            estudiante = new Student(nombre, genero, materia, calificacion);
