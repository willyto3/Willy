...
public class frmGestionarPersona extends javax.swing.JFrame {
    ...
    public void tablaP() {
        String[] columnas = { "Cod", "DUI", "NOMBRE", "APELLIDO", "EDAD", "GENERO", "TELEFONO", "DIRECCION",
                "NOMBRE-PAIS" };
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup().addGap(116, 116, 116).addComponent(jLabel11)
                        .addContainerGap(138, Short.MAX_VALUE)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addContainerGap(22, Short.MAX_VALUE).addComponent(jLabel11).addContainerGap()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGestionarPersona.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
